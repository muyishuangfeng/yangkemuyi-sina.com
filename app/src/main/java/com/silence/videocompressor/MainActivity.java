package com.silence.videocompressor;
...
import com.silence.videocompressor.util.Util;
import com.silence.videocompressor.util.VideoCompress;
...
//                tv_input.setText(inputPath);// /storage/emulated/0/DCIM/Camera/VID_20170522_172417.mp4
    ...
    private void initPermission() {
        List<PermissionItem> mList = new ArrayList<>();
        mList.add(new PermissionItem(Manifest.permission.READ_PHONE_STATE,
                "读写权限", R.drawable.permission_ic_storage));
        mList.add(new PermissionItem(Manifest.permission.WRITE_EXTERNAL_STORAGE,
                "读写权限", R.drawable.permission_ic_storage));
